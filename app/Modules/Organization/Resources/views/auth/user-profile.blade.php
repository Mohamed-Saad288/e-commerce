                ...
                <div class="card card-body mx-3 mx-md-4 mt-n6">
                    ...
                    <div class="card card-plain h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            <form method="POST" action="{{ route('organization.profile') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <textarea class="form-control border border-2 p-2" placeholder="Say something about yourself"
                                                  id="floatingTextarea2" name="about" rows="4">{{ old('about', auth()->user()->about) }}</textarea>
                                        @error('about')
                                        <p class="text-danger inputerror">{{ $message }}</p>
                                        @enderror
                                    </div>
