<x-organization::layout bodyClass="g-sidenav-show  bg-gray-200">

    <x-organization::navbars.sidebar activePage="billing"></x-organization::navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-organization::navbars.navs.auth titlePage="Billing"></x-organization::navbars.navs.auth>
        <!-- End Navbar -->
